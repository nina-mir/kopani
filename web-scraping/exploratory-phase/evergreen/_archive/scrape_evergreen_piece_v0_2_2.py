...
HEADERS = {
    "User-Agent": "Mozilla/5.0 (compatible; EvergreenReviewScraper/0.2.2)",
...
def scrape_piece(url, issue_label=None, issue_url=None, issue_number=None, input_title=None, input_author=None, input_type=None, order_in_section=None):
    ...
    try:
        ...
        return {
            ...
            "scrape_meta": {"scraped_at_utc": datetime.now(timezone.utc).strftime("%Y-%m-%dT%H:%M:%SZ"), "scraper_version": "0.2.2", "notes": [f"request_failed: {e}"]},
        }
